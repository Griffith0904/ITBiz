	...
	<!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${root}main">
                ...
                <div class="sidebar-brand-text mx-3">IT WL <sup>0.1</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="${mainpath}login.html">Login</a>
                        <a class="collapse-item" href="${mainpath}register.html">Register</a>
                        <a class="collapse-item" href="${mainpath}forgot-password.html">Forgot Password</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Other Pages:</h6>
                        <a class="collapse-item" href="${mainpath}404.html">404 Page</a>
                        <a class="collapse-item" href="${mainpath}blank.html">Blank Page</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="${mainpath}charts.html">
