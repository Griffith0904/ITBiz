    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div style='margin-top:40px; width:100%; height:calc(100% - 350px);border:2px solid red'>
                	...
                	<div class="row" style='height:100%; border:1px solid black'>
                        ...
                        <div class="col-xl-4 col-lg-5" style='margin-left:10px; height:100%;'>
                            <div class="card shadow mb-4" style='height:100%'>
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">지난 주의 차주 진행 업무3</h6>
                        ...
                        <!-- 가운데 (금주) -->
                        <div class="col-xl-4 col-lg-6" style='margin-left:-10px; '>
                            <!-- Project Card Example -->
                            <div class="card shadow mb-4" style='height:calc(100% - 200px);border:1px solid black;'>
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">금주의 진행 업무</h6>
                                </div>
                                <div class="card-body" style="border:1px solid red; height:calc(100% - 500px)">
	                                <!-- 각 섹터 -->
				                        ...
				                        <div class="card-body" >
				                            <div class="table-responsive" style='margin-top:-20px; margin-left:-20px;width:calc(100% + 40px); height:180px'>
				                                <table class="table table-bordered"  id="categoryDataTable" width="100%" cellspacing="0" >
				                                    ...
				                                    <tbody>
				                                    	<tr>
				                                    		<td style='padding:0.3rem !important'>1</td>
				                                    		<td style='padding:0.3rem !important'>김용진입니다.</td>
				                                    	</tr>
				                                    	<tr style='padding:0.3rem !important'>
				                                    		<td style='padding:0.3rem !important'>2</td>
				                                    		<td style='padding:0.3rem !important'>김용진입니다..</td>
				                                    	</tr>
				                                    	<tr style='padding:0.3rem !important'>
				                                    		<td style='padding:0.3rem !important'>3</td>
				                                    		<td style='padding:0.3rem !important'>김용진입니다...</td>
				                                    	</tr>
				                                    	<tr style='padding:0.3rem !important'>
				                                    		<td style='padding:0.3rem !important'>4</td>
				                                    		<td style='padding:0.3rem !important'>김용진입니다....</td>
				                                    	</tr>
				                                    	<tr style='padding:0.3rem !important'>
				                                    		<td style='padding:0.3rem !important'>5</td>
				                                    		<td style='padding:0.3rem !important'>김용진입니다....</td>
				                                    	</tr>
				                                    	<tr style='padding:0.3rem !important'>
				                                    		<td style='padding:0.3rem !important'>6</td>
				                                    		<td style='padding:0.3rem !important'>김용진입니다....</td>
				                                    	</tr>
				                                    </tbody>
				                                </table>
		                            ...
		                            <!-- 각 섹터 -->
                                	<div class="card border-left-primary shadow h-0 py-0" style='height:40px;margin-top:20px'>
		                                <div class="card-body" style='height:100%;'>
		                                    <div class="row no-gutters align-items-center" style="margin-left :-20px; margin-top:-20px; ">
		                                    	<div class="col-auto" style='margin-left:20px; margin-top:8px'>
		                                            <i class="fas fa-calendar fa-1x text-gray-300"></i>
                                	...
                                	<textarea id="ta_this_week_contents" class="form-control" rows="10" style='margin-top:10px; width:100%;height:calc(100% - 510px); border:1px solid red;' ></textarea>
